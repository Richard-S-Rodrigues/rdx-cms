...
INSERT INTO "new_projectMembers" ("created_at", "id", "is_creator", "member_id", "project_id", "role") SELECT "created_at", "id", "is_creator", "member_id", "project_id", "role" FROM "projectMembers";
