/*
  ...
  - You are about to drop the column `content` on the `blogPosts` table. All the data in the column will be lost.
...
INSERT INTO "new_blogPosts" ("author_id", "created_at", "description", "id", "is_published", "project_id", "title", "updated_at") SELECT "author_id", "created_at", "description", "id", "is_published", "project_id", "title", "updated_at" FROM "blogPosts";
